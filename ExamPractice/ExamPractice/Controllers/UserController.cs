...
namespace ExamPractice.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            User o = new User();
            List<SelectListItem> ctList = new List<SelectListItem>();
            ctList.Add(new SelectListItem { Text = "Select", Value ="0",Selected=true});
            while (dr2.Read())
            {
        ...
        public ActionResult Login()
        {
            ...
            HttpCookie objCookie = Request.Cookies["Usercookie"];
            if (objCookie == null)
            {
                return View();
            }
            else
            {
                ...
                s1 = objCookie.Values["userName"];
                s1 = objCookie.Values["pwd"];
                if (s1 == null && s2 == null)
                {
                    return View();
                }
